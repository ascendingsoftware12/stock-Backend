...
def get_SalesAnlaysis_kore_all_in_column_live_controller():
    try:
        print("21hsgdytasfdghasgy")
        conditions = []
        price_conditions = []
...
def search_SalesContributuion_kore_sales_type_controller():
    try:
        conditions = []
        price_conditions = []
...
def search_SalesContribution_kore_sales_controller():
    try:
        conditions = []
        price_conditions = []
        ...
        if total_sales is None:
            ...
            total_sales_in_cr = total_sales / 100000  

        formatted_sales_in_cr = f"{total_sales_in_cr:.2f} Lk"
...
def search_SalesContributuion_kore_section_controller():
    try:
...
def search_SalesContributuion_kore_brand_sales_controller():
    try:
        page = request.args.get("page", 1, type=int)
        limit = request.args.get("limit", 10, type=int)
        offset = (page - 1) * limit
...
def search_SalesContributuion_kore_item_sales_controller():
    try:
        page = request.args.get("page", 1, type=int)
        limit = request.args.get("limit", 10, type=int)
        offset = (page - 1) * limit
...
def search_Discount_Analysis_kore_section_controller():
    try:
        page = request.args.get("page", 1, type=int)
        limit = request.args.get("limit", 10, type=int)
        offset = (page - 1) * limit
...
def search_Discount_Analysis_kore_brand_controller():
    try:
        page = request.args.get("page", 1, type=int)
        limit = request.args.get("limit", 10, type=int)
        offset = (page - 1) * limit
...
def search_Discount_Analysis_kore_model_no_controller():
    try:
        page = request.args.get("page", 1, type=int)
        limit = request.args.get("limit", 10, type=int)
        offset = (page - 1) * limit
...
def search_Discount_Analysis_kore_discount_controller():
    try:
        conditions = []
        price_conditions = []
        ...
        if disc_amt is None:
            ...
            disc_amt_in_cr = disc_amt / 100000

        
        formatted_disc_amt_in_cr = f"{round(disc_amt_in_cr, 2)} Lk"
...
def search_Discount_Analysis_kore_discount_Percentage_controller():
    try:
        conditions = []
        price_conditions = []
