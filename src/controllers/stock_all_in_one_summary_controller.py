...
def search_StockAnalysis_common_controller():
    try:
        ...
        if selling_price:
            try:
                ...
                if 0 <= selling_price <= 3000:
                    conditions.append((StockAllInOneSummary.selling_price >= 0) & (StockAllInOneSummary.selling_price <= 3000))
                elif 3000 < selling_price <= 5000:
                    conditions.append((StockAllInOneSummary.selling_price > 3000) & (StockAllInOneSummary.selling_price <= 5000))
                elif 5000 < selling_price <= 8000:
                    conditions.append((StockAllInOneSummary.selling_price > 5000) & (StockAllInOneSummary.selling_price <= 8000))
                elif 8000 < selling_price <= 10000:
                    conditions.append((StockAllInOneSummary.selling_price > 8000) & (StockAllInOneSummary.selling_price <= 10000))
                elif 10000 < selling_price <= 15000:
                    conditions.append((StockAllInOneSummary.selling_price > 10000) & (StockAllInOneSummary.selling_price <= 15000))
                elif 15000 < selling_price <= 20000:
                    conditions.append((StockAllInOneSummary.selling_price > 15000) & (StockAllInOneSummary.selling_price <= 20000))
                elif 20000 < selling_price <= 30000:
                    conditions.append((StockAllInOneSummary.selling_price > 20000) & (StockAllInOneSummary.selling_price <= 30000))
                elif 30000 < selling_price <= 40000:
                    conditions.append((StockAllInOneSummary.selling_price > 30000) & (StockAllInOneSummary.selling_price <= 40000))
                elif 40000 < selling_price <= 70000:
                    conditions.append((StockAllInOneSummary.selling_price > 40000) & (StockAllInOneSummary.selling_price <= 70000))
                elif 70000 < selling_price <= 100000:
                    conditions.append((StockAllInOneSummary.selling_price > 70000) & (StockAllInOneSummary.selling_price <= 100000))
                elif selling_price > 100000:
                    conditions.append(StockAllInOneSummary.selling_price > 100000)
            except ValueError:
        ...
        if "MySQL server has gone away" in str(e):
            return search_StockAnalysis_common_controller()
        else:
...
def get_StockAnlaysis_all_in_column_live_controller():
    try:
        ...
        if price_breakup2:
            sales_per_unit = StockAllInOneSummary.selling_price
            price_breakup2_list = price_breakup2.split(',') if isinstance(price_breakup2, str) else price_breakup2
...
def search_StockAnalysis_quantity_controller():
    try:
        page = request.args.get("page", 1, type=int)
        limit = request.args.get("limit", 10, type=int)
        offset = (page - 1) * limit
...
def search_StockAnalysis_Selling_Price_controller():
    try:
        page = request.args.get("page", 1, type=int)
        limit = request.args.get("limit", 10, type=int)
        offset = (page - 1) * limit
        ...
        Selling_Price = selling_price_query.scalar()

        if Selling_Price is None:
            Selling_Price = 0 

        formatted_selling_price = int(Selling_Price)

        selling_price_result_data = {
            "Selling_Price": formatted_selling_price
        }

        return jsonify({
            "success": 1,
            "data": selling_price_result_data
        })
...
def search_StockAnalysis_No_Of_Brands_controller():
    try:
        page = request.args.get("page", 1, type=int)
        limit = request.args.get("limit", 10, type=int)
        offset = (page - 1) * limit
...
def search_StockAnalysis_No_Of_Items_controller():
    try:
        page = request.args.get("page", 1, type=int)
        limit = request.args.get("limit", 10, type=int)
        offset = (page - 1) * limit
...
def search_StockAnalysis_Ageing_controller():
    try:
        page = request.args.get("page", 1, type=int)
        limit = request.args.get("limit", 10, type=int)
        offset = (page - 1) * limit
...
def search_StockAnalysis_Holding_Cost_controller():
    try:
        page = request.args.get("page", 1, type=int)
        limit = request.args.get("limit", 10, type=int)
        offset = (page - 1) * limit
        ...
        holding_value_query = db.session.query(
            func.sum(
                (StockAllInOneSummary.selling_price * StockAllInOneSummary.qty) / 365 * 0.09 * StockAllInOneSummary.overall_age
            ).label('holding_value')
...
def search_StockAnalysis_Branch_controller():
    try:
        page = request.args.get("page", 1, type=int)
        limit = request.args.get("limit", 10, type=int)
        offset = (page - 1) * limit
...
def search_StockAnalysis_City_controller():
    try:
        page = request.args.get("page", 1, type=int)
        limit = request.args.get("limit", 10, type=int)
        offset = (page - 1) * limit
...
def search_StockAnalysis_section_controller():
    try:
        page = request.args.get("page", 1, type=int)
        limit = request.args.get("limit", 10, type=int)
        offset = (page - 1) * limit
...
def search_StockAnalysis_Item_Category_controller():
    try:
        page = request.args.get("page", 1, type=int)
        limit = request.args.get("limit", 10, type=int)
        offset = (page - 1) * limit
...
def search_StockAnalysis_Product_controller():
    try:
        page = request.args.get("page", 1, type=int)
        limit = request.args.get("limit", 10, type=int)
        offset = (page - 1) * limit
...
def search_StockAnalysis_brand_controller():
    try:
        page = request.args.get("page", 1, type=int)
        limit = request.args.get("limit", 10, type=int)
        offset = (page - 1) * limit
...
def search_StockAnalysis_ModelNo_controller():
    try:
        page = request.args.get("page", 1, type=int)
        limit = request.args.get("limit", 10, type=int)
        offset = (page - 1) * limit
...
def search_StockAnalysis_Item_controller():
...
def get_stock_table_modification_date_and_time_controller():
    try:
